<template>
  ...
  <header>
    ...
    <ul class="recommendtype">
      <li @click="setType(1)" :class="typeCss[1]">战争<i class="fa fa-caret-down"></i></li>
      <li @click="setType(2)" :class="typeCss[2]">科幻</li>
      <li @click="setType(3)" :class="typeCss[3]">爱情</li>
      <li @click="setType(4)" :class="typeCss[4]">惊悚</li>
      <li @click="setType(5)" :class="typeCss[5]">动画</li>
...
export default {
  ...
  created() {
    this.type2 = this.$getLocalStorage('cateId')
    this.setType(this.type2)
  ...
  methods: {
    ...
    getFileList(m) {
      ...
      this.$axios.get("/film/list2/" + this.type2,
        {
          params: {
