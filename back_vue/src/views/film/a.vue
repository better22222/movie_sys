    ...
    <div>
        ...
        <el-form :iniline="true" :model="searchForm">
            ...
            <el-form-item>
                ...
                <el-popconfirm title="确定删除该这些排片数据？" @confirm="deleteArrangement()">
        ...
        <el-table :cell-style:="{ padding: '20px' }" :data="tableData" border stripe h
            ...
            <el-table-column prop="seat_number" label="座位数" width="70">
            </el-table-column>

            <el-table-column prop="box_office" label="票房统计" width="90">
            </el-table-column>

            <el-table-column prop="price" label="价格" width="60">
            </el-table-column>

            <el-table-column prop="type" label="放映类型" width="90" align="center">
            </el-table-column>

            <el-table-column prop="date" label="放映日期" width="120">
            </el-table-column>
            ...
            <el-table-column prop="founder" label="排片人" width="70">
            </el-table-column>
            ...
            <el-table-column label="操作">
                <template slot-scope="scope">
                    ...
                    <template>
                        <el-popconfirm title="确定删除该电影数据？" @confirm="deleteArrangement(scope.row.id)">
      ...
      -->
        ...
        <el-dialog title="顾客信息" :visible.sync="dialogFormVisble" width="600px">
            <el-form :model="arrangementForm" ref="arrangementForm" :rules="arrangementFormRules" label-width="100px"
                class="demo-ruleForm">

                <el-form-item label="电影名" label-width="100px" prop="name">
                    <el-input v-model="arrangementForm.name" auto-complete="off" label-width="90px"></el-input>
                </el-form-item>

                <el-form-item label="座位数" label-width="100px" prop="type">
                    <el-input v-model="arrangementForm.seat_number" auto-complete="off" label-width="90px"></el-input>
                </el-form-item>

                <el-form-item label="座位数" label-width="100px" prop="type">
                    <el-input v-model="arrangementForm.box_office" auto-complete="off" label-width="90px"></el-input>
                </el-form-item>

                <el-form-item label="价格" label-width="100px">
                    <el-input v-model="arrangementForm.price" auto-complete="off" label-width="90px"></el-input>
                </el-form-item>

                <el-form-item label="类型">
                    <el-input v-model="arrangementForm.type" auto-complete="off" label-width="90px"></el-input>
                </el-form-item>

                <el-form-item label="放映时间" label-width="100px" prop="release_time">
                    <div class="block">
                ...
                <el-form-item label="开始时间" label-width="100px" prop="release_time">
                    <el-time-picker v-model="arrangementForm.start_time" :picker-options="{
                        selectableRange: '6:30:00 - 23:30:00'
                    }" placeholder="任意时间点">
                    </el-time-picker>
                </el-form-item>

                
                <el-form-item label="结束时间" label-width="100px" prop="release_time">
                    <el-time-picker v-model="arrangementForm.end_time" :picker-options="{
                        selectableRange: '6:30:00 - 23:30:00'
                    }" placeholder="任意时间点">
                    </el-time-picker>
                </el-form-item>
                ...
                <el-form-item label="排片人">
                    <el-input v-model="arrangementForm.founder" auto-complete="off" label-width="90px"></el-input>
                </el-form-item>

                <el-form-item>
                    <el-button type="primary" @click="submitForm('arrangementForm')">提交表单</el-button>
    ...
    methods: {
        ...
        submitForm(formName) {
            this.$refs[formName].validate((valid) => {
                //表单中的rules验证通过
                if (valid) {
                    this.$axios.post('/system/arrangement/' + (this.arrangementForm.id ? 'update' : 'save'), this.$qs.stringify(this.filmForm))
                        .then((response) => {
                            this.$message({
                                showClose: true,
                                message: '编辑排片成功',
        ...
        deleteArrangement(id) {
            ...
            this.$axios.post('/system/arrangement/delete', roleIds).then(response => {
                this.$message({
                    showClose: true,
                    message: '删除成功',
                    type: 'success',
